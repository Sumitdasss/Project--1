    ...
    />
            ...
            <div className="absolute bottom-[-150px] left-0 w-full bg-white p-6 transition-all duration-500 group-hover:bottom-0">
              <ul className="flex flex-col gap-3">
                ...
                <button onClick={()=>dispatch({type:"Add", Product2: Product2})}  className="flex items-center justify-end gap-4 text-[#262626] font-bold duration-300">
          ...
          <div className="mt-6 flex justify-between items-start">
            <div>
              <h3 className="text-[20px] font-bold text-[#262626]">{Product2.title}</h3>
              <p className="text-[#767676] text-[16px] mt-2">{Product2.color}</p>
            </div>
            <div className="text-right">
              <p className="text-[16px] text-[#262626] font-bold">${Product2.price}</p>
              <p className="text-[#767676] text-[14px] line-through">
                {Product2.discountPercentage}% Off
              </p>
            </div>
          </div>
        </div>
